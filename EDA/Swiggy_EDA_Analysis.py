...
st.title("Swiggy Food Delivery Data Analysis Dashboard")
...
col4.metric("Total Ratings", f"{rating_count:,.0f}")
...
st.header("Veg vs Non-Veg Revenue")
...
st.header("Top 5 Cities by Sales")
